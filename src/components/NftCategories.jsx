...
const TrendingNft = () => {
	...
	return (
		  <section className="w-full relative px-4 md:px-32 dark:bg-darkBg dark:text-darkText">
		    <div className="flex items-center justify-between"><h1 className="font-semibold text-md md:text-center">Trending 🔥</h1><Link to="/market" className="text-sm text-subColor font-semibold">see all >>></Link></div>
