...
const Category = () => {
	...
	return (
		  <div className="px-4 dark:bg-darkBg dark:text-darkText md:px-32 pt-6">
		    ...
		    <div className="flex justify-between items-center gap-2 relative md:justify-center">{categories.map(cate => {
		    	...
		    	return (
		    		  <div key={id} className="border-2 border-gray-100 w-[100px] h-[100px] p-2 text-center flex justify-center items-center rounded-md dark:bg-gray-900 dark:border-0"><a href={path} className="font-semibold">
		    		    <span className="dark:bg-gray-800 bg-gray-100 flex justify-center items-center rounded-full p-2 h-[50px] w-[50px] mb-2 text-subColor">{icon}</span>
